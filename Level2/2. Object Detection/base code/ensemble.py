...
def parse_args():
    ...
    parser.add_argument("--output_csv", default="/opt/ml/detection/ensemble_output/submission11111.csv")
...
def main():
    ...
    print('순서 :', os.listdir(args.csv_folder_path))
    ...
    for i, image_id in enumerate(image_ids):
        ...
        for df in submission_df:
            ...
            # submission_df가 for문을 돌면서 각 df마다 boxes_list, scores_list, labels_list에 값을 채운다
    ...
    # print(prediction_strings[0]) # test/0000.jpg 에 대한 predict
