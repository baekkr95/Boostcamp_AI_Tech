...
# setup
model_name = 'detr_r50_8x2_150e_coco'
job_name = nowDatetime


cfg = Config.fromfile(f'/opt/ml/detection/baseline/mmdetection/configs/_boost_/config/{model_name}.py')
...
# directory
cfg.data_root = '/opt/ml/detection/dataset/'
cfg.json_root = '/opt/ml/detection/stratified_kfold/'
cfg.work_dir = '/opt/ml/detection/baseline/mmdetection/configs/_boost_/work_dirs/baseline_dir'
...
cfg.runner.max_epochs = 12  # epochs
cfg.data.workers_per_gpu = 4  # num_worker
cfg.data.samples_per_gpu = 8  # batch_size
