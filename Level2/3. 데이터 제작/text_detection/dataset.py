...
class SceneTextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # funcs.append(A.Blur(p=0.5))
        # funcs.append(A.HorizontalFlip(p=1.0))
        # # funcs.append()
        ...
        #     ]
        # )
        # transform = alb_transform(image=image, word_bboxes=word_bboxes, roi_mask=roi_mask)
        # image = transform['image']
        # word_bboxes = transform['word_bboxes']
        # roi_mask = transform['roi_mask']
