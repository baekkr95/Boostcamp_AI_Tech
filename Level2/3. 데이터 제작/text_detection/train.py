...
def parse_args():
    ...
    parser.add_argument('--train_eval', type=bool, default=False, help='boolean about evaluation on train dataset')     # 가급적 false
    parser.add_argument('--eval_interval', type=int, default=1, help='evaluation metric log interval')                  # 몇 epoch 마다 evaluation 할 건지
    # training parameter
    ...
    # etc
    parser.add_argument('--sweep', type=bool, default=False, help='sweep option')    # 일단은 False로 사용 중
